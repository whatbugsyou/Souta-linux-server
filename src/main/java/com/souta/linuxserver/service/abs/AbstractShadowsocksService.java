...
public abstract class AbstractShadowsocksService extends AbstractSocksService<Shadowsocks> implements ShadowsocksService {
    ...
    public AbstractShadowsocksService(NamespaceService namespaceService, PPPOEService pppoeService, NamespaceCommandService commandService, Integer listenPort, ShadowsocksConfig config) {
