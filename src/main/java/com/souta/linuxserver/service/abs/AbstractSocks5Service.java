...
import com.souta.linuxserver.proxy.ProxyConfig.Socks5Config;
...
public abstract class AbstractSocks5Service extends AbstractSocksService<Socks5> implements Socks5Service {
    ...
    public AbstractSocks5Service(NamespaceService namespaceService, PPPOEService pppoeService, NamespaceCommandService commandService, Integer listenPort, Socks5Config socks5Config) {
